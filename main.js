...
var _Http_toTask = F2(function(request, maybeProgress)
{
	return _Scheduler_binding(function(callback)
	{
		...
		xhr.addEventListener('load', function() {
			callback(_Http_handleResponse(xhr, request.aM.a));
		});
...
function _Http_configureRequest(xhr, request)
{
	...
	xhr.responseType = request.aM.b;
	xhr.withCredentials = request.a7;

	elm$core$Maybe$isJust(request.a1) && (xhr.timeout = request.a1.a);
}
...
function _Http_toResponse(xhr)
{
	return {
		a5: xhr.responseURL,
		a$: { aJ: xhr.status, v: xhr.statusText },
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { aQ: 'hidden', C: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { aQ: 'mozHidden', C: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { aQ: 'msHidden', C: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { aQ: 'webkitHidden', C: 'webkitvisibilitychange' }
		: { aQ: 'hidden', C: 'visibilitychange' };
}
...
var author$project$Main$initState = {m: 0, r: author$project$Main$emptyCounts, u: '', E: elm$core$Dict$empty, v: elm$core$Maybe$Nothing, Q: elm$core$Maybe$Nothing};
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {af: fragment, ag: host, ak: path, am: port_, aq: protocol, ar: query};
	});
...
var elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {n: frag, p: params, l: unvisited, i: value, q: visited};
	});
...
var author$project$Main$GotLessonsApiResponse = function (a) {
	return {$: 2, a: a};
};
var author$project$Main$GotReviewsApiResponse = function (a) {
	return {$: 1, a: a};
};
var author$project$Main$GotTimezone = function (a) {
	return {$: 4, a: a};
};
var author$project$Main$Route = function (a) {
	return {$: 0, a: a};
};
var author$project$Main$ApiResponse = F3(
	function (totalCount, pages, data) {
		return {N: data, V: pages, a3: totalCount};
	});
var author$project$Main$PagesResponse = F3(
	function (nextUrl, previousUrl, perPage) {
		return {T: nextUrl, aY: perPage, aZ: previousUrl};
	});
...
var author$project$Main$pagesDecoder = A4(
	elm$json$Json$Decode$map3,
	author$project$Main$PagesResponse,
	A2(
...
var author$project$Main$collectionDecoder = function (dataDecoder) {
	return A4(
		elm$json$Json$Decode$map3,
		author$project$Main$ApiResponse,
		A2(elm$json$Json$Decode$field, 'total_count', elm$json$Json$Decode$int),
		A2(elm$json$Json$Decode$field, 'pages', author$project$Main$pagesDecoder),
		A2(
			elm$json$Json$Decode$field,
			'data',
...
var author$project$Main$getCollection = F4(
	function (key, url, decoder, messageCons) {
		...
		var request = elm$http$Http$request(
			{
				...
				aM: elm$http$Http$expectJson(
					author$project$Main$collectionDecoder(decoder)),
				aP: _List_fromArray(
					[
		...
		return A2(elm$http$Http$send, messageCons, request);
	});
var author$project$Main$Lesson = function (startedAt) {
	return {ax: startedAt};
};
...
var author$project$Main$lessonDecoder = A2(
...
var author$project$Main$Review = F3(
	function (startSrs, endSrs, createdAt) {
		return {aK: createdAt, ad: endSrs, aw: startSrs};
	});
		...
		elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					...
					key,
					author$project$Main$Route('reviews'),
					author$project$Main$reviewDecoder,
					author$project$Main$GotReviewsApiResponse),
					A4(
					author$project$Main$getCollection,
					key,
					author$project$Main$Route('assignments'),
...
var author$project$Main$LoadedState = F6(
	function (probas, reviewCount, rates, lessonRate, lessonRateString, lessonDates) {
		return {ah: lessonDates, D: lessonRate, R: lessonRateString, an: probas, X: rates, au: reviewCount};
	});
			...
			_List_fromArray(
				[
					...
					elm$json$Json$Encode$list(
						elm$json$Json$Encode$list(elm$json$Json$Encode$float))($.aC)),
					_Utils_Tuple2(
					'b',
					elm$json$Json$Encode$list(elm$json$Json$Encode$float)($.aE))
				]));
	});
...
var author$project$Main$checkState = function (loadingState) {
	var _n0 = loadingState.Q;
	if (!_n0.$) {
		var zone = _n0.a;
		if (loadingState.m === 2) {
			var total = elm$core$List$sum(
				elm$core$Dict$values(loadingState.r));
			var probas = author$project$Main$fixProbabilities(
				author$project$Main$computeProbabilities(loadingState.r));
			var lessons = elm$core$Dict$toList(loadingState.E);
			return _Utils_Tuple2(
				...
				author$project$Matrix$solve(
					{
						aC: A2(author$project$Matrix$makepProblemMatrix, 8, probas),
						aE: _List_fromArray(
							[-1.0, 0, 0, 0, 0, 0, 0, 0])
					}));
		} else {
			return _Utils_Tuple2(
				author$project$Main$Loading(loadingState),
				elm$core$Platform$Cmd$none);
		}
	} else {
		return _Utils_Tuple2(
...
var author$project$Main$countReview = F2(
	function (review, counts) {
		return A3(
			elm$core$Dict$update,
			_Utils_Tuple2(review.aw, review.ad),
			A2(
				elm$core$Basics$composeR,
				elm$core$Maybe$withDefault(0),
				A2(
				...
				case 1:
					if (!_n0.a.a.$) {
						if (!_n0.b.$) {
							...
							var newCounts = A3(elm$core$List$foldr, author$project$Main$countReview, loadingState.r, resp.N);
...
var author$project$Lessons$viewLesson = function (_n0) {
	var date = _n0.a;
	var value = _n0.b;
	return A2(
		elm$html$Html$p,
...
var author$project$Lessons$view = function (lessons) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
		...
		_Utils_ap(
			...
			A2(elm$core$List$map, author$project$Lessons$viewLesson, lessons)));
};
...
var author$project$Main$viewLoaded = function (state) {
	var ifComputed = function () {
		var _n0 = state.X;
		if (!_n0.$) {
			var rates = _n0.a;
			return _List_fromArray(
				[
					A2(author$project$Main$viewRates, rates, state.D),
					A2(author$project$Main$viewQueueSizes, rates, state.D),
					author$project$Main$viewBurnTime(rates),
					author$project$Lessons$view(state.ah)
				]);
		} else {
			return _List_Nil;
		}
		...
		[
			...
			_List_fromArray(
				[
					...
					author$project$Main$viewProbas(state.an),
					A2(
					elm$html$Html$p,
					_List_Nil,
					_List_fromArray(
						[
							elm$html$Html$text(
							'(based on ' + (elm$core$String$fromInt(state.au) + ' reviews)'))
						]))
				])),
			A2(
			elm$html$Html$div,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text(
								A2(elm$core$Maybe$withDefault, '', state.v))
							]))
					]))
			]));
};
var author$project$Main$view = function (state) {
	if (!state.$) {
		var st = state.a;
		return author$project$Main$viewLoading(st);
	} else {
		var st = state.a;
		return author$project$Main$viewLoaded(st);
	}
};
...
var author$project$Main$main = elm$browser$Browser$element(
	{aS: author$project$Main$init, a0: author$project$Main$subscriptions, a4: author$project$Main$update, a6: author$project$Main$view});
