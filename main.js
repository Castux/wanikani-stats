...
var author$project$Main$GotLessonsApiResponse = function (a) {
	return {$: 'GotLessonsApiResponse', a: a};
};
var author$project$Main$GotReviewsApiResponse = function (a) {
	return {$: 'GotReviewsApiResponse', a: a};
};
	...
	return _Utils_Tuple2(
		author$project$Main$Loading(
			_Utils_update(
				...
				{
					key: key,
					message: elm$core$Maybe$Just('Loading...')
				})),
...
var author$project$Main$checkState = function (loadingState) {
	if (loadingState.callsFinished === 2) {
		...
		while (true) {
			switch (_n0.a.$) {
				case 'NewKey':
					var key = _n0.a.a;
					return author$project$Main$startLoading(key);
				case 'GotReviewsApiResponse':
					if (_n0.a.a.$ === 'Ok') {
						if (_n0.b.$ === 'Loading') {
							var resp = _n0.a.a.a;
							var loadingState = _n0.b.a;
							var newCounts = A3(elm$core$List$foldr, author$project$Main$countReview, loadingState.counts, resp.data);
							var newState = _Utils_update(
								loadingState,
								{counts: newCounts});
							var _n1 = resp.pages.nextUrl;
							if (_n1.$ === 'Just') {
								var nextUrl = _n1.a;
								return _Utils_Tuple2(
		...
		[
			...
			_List_fromArray(
				[
					...
					author$project$Main$viewProbas(state.probas),
					A2(
					elm$html$Html$p,
					_List_Nil,
					_List_fromArray(
						[
							elm$html$Html$text(
							'(based on ' + (elm$core$String$fromInt(state.reviewCount) + ' reviews)'))
						]))
				])),
			A2(
			elm$html$Html$div,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text(
								A2(elm$core$Maybe$withDefault, '', state.message))
							]))
					]))
			]));
};
